...
//Begin as pivot	  BY Priceton
	static int PartitionBegin(int[]array, int C_left, int C_right){
		...
		swap(array,C_left,end); //swap(array,left,begin-1); either end or begin
		return end;		
	}
	/*End as pivot  BY Priceton BUT FAIL when return  swap(array,C_right,end), return swap(array,C_right,begin) is OK BUT for begin pivot return either begin or end is OK   UNKNOW REASON
	* failure sample:
	*2100 23 323 45 10 2 3 8 12 56 78 34 410 7000 
	*410 23 323 45 10 2 3 8 12 56 78 34 2100 7000 
	*/
//	static int PartitionEndFail(int[]array, final int C_left, final int C_right){
...
//			
//		}
//		swap(array,C_right,end); //e: swap(array,left,begin-1);
//		for(int a:array)
//			System.out.print(a+" ");		
//		System.out.println();
//		return end;		
